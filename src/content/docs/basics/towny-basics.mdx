...
Towny is the core of gameplay on LumaMC. It allows players to create and manage towns, nations, and outposts with a variety of commands. Towny is a complex plugin, but it's easy to get the hang
...
manage the town's bank, but not claim land. Ranks can be assigned or removed from players using the
...
Plots are an important part of Towny and general claiming on LumaMC. Players often get stuck when
...
**Plot permissions can be configured, allowing or disallowing a plot to spawn mobs, have fire spread, have explosions, or other destructive actions:**
