...
The resource pack usually only takes a few seconds to apply, though this can change depending on if
...
LumaMC's resource pack is sent upon joining the server. If you rejected the resource pack in the past,
...
list, then click "Edit". Click on the "Server Resource Packs" button until it says "Server
