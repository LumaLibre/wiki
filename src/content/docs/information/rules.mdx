...
- Resource gathering must be done in the designated resource worlds. Defacing or excessively
...
- Attempting to bypass the anti-AFK system or using in-game mechanics/third-party software to
  avoid being marked as AFK is prohibited.
- Abusing job systems or exploiting them for unfair advantage (e.g. Using water or torches to break blocks quicker in a job such as Builder).
...
### Folia Region Guidelines

- Saturating a region with farms is not allowed (high utilization or MSPT). Any violating farm or grinder will be removed without warning.
- Excessive use of tile entities that cause lag to Minecraft clients is not allowed.
- Farms or areas that cause a concerning amount of lag to a region, regardless of their location may be asked to have certain portions removed or changed.
- We reserve the right to ask players to change their farms for any given reason or remove portions of farms we feel are unfit for gameplay on Luma.
