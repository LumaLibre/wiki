...
Lunar tools are the highest value relic being the strongest, most powerful tools before Astral
tools!
...
from a seasonal event, challenge, or other event-related activities. Event item enchantments can vary
