...
<div class="list">
* Token Formula: min(points + 2, 15) = tokens
</div>
...
Points are granted based on how many kills a player gets. For every kill, the player earns 2 points.

## Paintball 2.1

<div class="list">
* Token Formula: min( (8 + (won ? 1 : 0)) + (points ≤ 5 ? max(5 - points, 2) : 0), 15) = tokens
</div>
