...
Runners cannot see the hunter **unless** the hunter is within `3 blocks-` of the runner **OR** the hunter
is within `7 blocks-` of the runner and the hunter has a *direct line of sight of the hunter.
