...
Mob balls are an item that can be used to capture and release mobs anywhere on LumaMC.

## Obtaining Mob Balls

Mob balls can be obtained a variety of ways, including purchasing them from the `/luminshop` for 15
...
<CenteredImage
  ...
  alt="Mob balls available within the `/luminshop`. The price is set to 15 lumins as of writing."
  tailwind="w-128"
/>
