...
Mob balls can be obtained a variety of ways, including purchasing them from the `/luminshop`, crafting them with the recipe below _(requires Farmer level 35 or Etheral rank)_, and
